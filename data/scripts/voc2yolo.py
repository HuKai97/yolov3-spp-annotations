...
images_path = os.path.join(dir_path, "VOC", "images")
xml_path = os.path.join(dir_path, "VOC", "Annotations")
train_txt_path = os.path.join(dir_path, "VOC", "ImageSets", "train.txt")
val_txt_path = os.path.join(dir_path, "VOC", "ImageSets", "val.txt")
# label标签对应json文件
label_json_path = os.path.join(dir_path, "pascal_voc_classes.json")
